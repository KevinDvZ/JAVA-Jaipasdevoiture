...
public class Agence {
    ...
    public void afficherStock() {
        ...
        for (Vehicule detailStock : stockActuel) {
            System.out.println(indice + " : " + detailStock.getClass().getEnclosingClass().getName()
                    + " avec pour marque " + detailStock.marque + " de couleur " + detailStock.couleur
                    + (detailStock.disponible ? ", disponible." : ", pas disponible."));
    ...
    public void louerVehicule(int numeroVehicule, Client client) {
        if ((numeroVehicule >= 0) && (numeroVehicule < this.stockActuel.length)) {
            if (this.stockActuel[numeroVehicule].disponible == true) {
                ...
                System.out.println(this.stockActuel[numeroVehicule].marque + " loué à "
            ...
            System.out.println("Il n'y a pas de véhicule à cet emplacement");
        }
    }
