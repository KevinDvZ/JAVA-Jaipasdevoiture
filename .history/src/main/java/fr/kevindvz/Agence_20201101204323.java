    ...
    public void retournerVehicule(int numeroVehicule) {
        ...
        if ((numeroVehicule >= 0) && (numeroVehicule < this.stockActuel.length)) {
            ...
            if (this.stockActuel[numeroVehicule].disponible == false) {
                ...
                System.out.println(this.stockActuel[numeroVehicule].marque +"a réintégré le stock de"+this.adresse.ville+".");
    } else if(this.stockActuel[numeroVehicule].disponible == true){System.out.println(this.stockActuel[numeroVehicule].marque+"déjà dans le stock de"+this.adresse.ville);}
    else {System.out.println("Emplacement du véhicule inexistant dans le stock.");};
