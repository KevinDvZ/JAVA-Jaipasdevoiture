...
public class Agence {
    ...
    public void afficherStock() {
        ...
        for (Vehicule detailStock : stockActuel) {
            System.out.println(Array.indexOf(detailStock, 0) + " : " + detailStock.marque + " de couleur "
                    + detailStock.couleur + (detailStock.disponible ? "est disponible" : "n'est pas disponible."));
